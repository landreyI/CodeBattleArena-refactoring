...
{
    public class GetProgrammingTasksListHandlerTests
    {
        private readonly Mock<IRepository<ProgrammingTask>> _repoMock;
        private readonly Mock<IMapper> _mapperMock;
        private readonly GetProgrammingTasksListHandler _handler;

        public GetProgrammingTasksListHandlerTests()
        {
            ...
            _handler = new GetProgrammingTasksListHandler(_repoMock.Object, _mapperMock.Object);
        }
        ...
        public async Task Handle_ShouldReturnCorrectPagination(int page, int size, int total, int expected)
        {
            ...
            var query = new GetProgrammingTasksListQuery(filter);
