...
{
    public class ProgrammingTaskUpdatedEventHandler 
        : INotificationHandler<DomainEventNotification<ProgrammingTaskUpdatedIntegrationEvent>>
    {
        ...
        public ProgrammingTaskUpdatedEventHandler(ITaskNotificationService taskNotificationService, IRepository<ProgrammingTask> taskRepository, IMapper mapper)
        {
        ...
        public async Task Handle(DomainEventNotification<ProgrammingTaskUpdatedIntegrationEvent> notification, CancellationToken ct)
        {
